...
public interface Enlace_EnvioDAO {
    ...
    boolean Modificar_Tienda(int codigo, int propietario, String nombre, String dirreccion, int telefono, String path);
    boolean Elimnar_Tienda(int codigo, int propietario, String nombre, String dirreccion, int telefono, String path);
    ...
    boolean ModificarProducto(int codigo,String nombre, String Cantidad, String marca, String color, String Tamaño, String path, int sucursal);
    boolean Eliminar_Producto(int codigo,String nombre, String Cantidad, String marca, String color, String Tamaño, String path, int sucursal);
