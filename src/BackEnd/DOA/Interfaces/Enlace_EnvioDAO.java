...
public interface Enlace_EnvioDAO {
    ...
    boolean Crear_Usuario(int id,String nombre, String apellido, String password, String telefono, String email,String dirreccion);
    boolean Crear_Tienda(int codigo, int propietario, String nombre, String dirreccion, String telefono, String path);
    boolean Modificar_Tienda(int codigo, int propietario, String nombre, String dirreccion, String telefono);
    boolean Elimnar_Tienda(int codigo, int propietario, String nombre, String dirreccion, String telefono);
